...
You can combine `scale_x_break()` and `scale_y_break()` to create dual-axis break plots. This is particularly useful when you have data points that form distinct clusters with large gaps in between on both dimensions.
...
Multiple breaks on both axes are also supported.
...
### Feature 4: Zoom in or zoom out of subplots

```{r}
p1 + scale_x_break(c(7, 17), scales = 1.5) + scale_x_break(c(18, 21), scales=2)
```

### Feature 5: Support reverse scale
...
### Feature 6: Compatible with scale transform functions
...
### Feature 7: Compatible with `coord_flip`
...
### Feature 8: Compatible with `facet_grid` and `facet_wrap`
...
### Feature 9: Compatible with legends
...
### Feature 10: Supports all plot labels
...
### Feature 11: Allows setting tick labels for subplots
...
### Feature 12: Compatible with dual axis
...
### Feature 13: Compatible with patchwork
